...
5. Generate certificate to sign the appx package. The user will be prompted to create passwords for the certs, and then again to use them (4 prompts).
...
# Build the solution
& $msbuildLocation $SlnPath /t:Rebuild "/p:Configuration=Release;OutDir=.\Out\;Platform=x64;AppxPackageSigningEnabled=false"
...
# Install the package
[ScriptBlock]::Create($eliteAppxAddLocation).Invoke()